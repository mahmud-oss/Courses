...
class _State extends State<Myapp>{//cloth
  String _value='George is getting upset';
        ...
        child: new Center(
          child: new Column(
            children: [//ACTUALLY children<widget>. widgets are generic placeholder for objects
              new Text(_value),
              new RaisedButton(onPressed: ()=>_onPressed('Serenity now'), child: new Text('festivus'),),
              new FlatButton(onPressed: ()=>_onPressed('Serenity now, serenity now'), child: new Text('festivus'),)
            ],
          ),
        )
        ),
